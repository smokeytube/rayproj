...
class Background {
    ...
    this() {
        ...
        this.sky = LoadTexture("./source/sprites/res/sky.png");
        setScale();
    }
    ...
    void drawBackground(float x, float y, int screen_width, int screen_height) {
        ...
        this.sky_rect1 = Rectangle(x/10, y, this.background_width, this.background_height);
        ...
        for (int i = 0; i < screen_width; i += background_width) {
            DrawTextureRec(this.sky, this.sky_rect1, Vector2(i, 0), Colors.WHITE);
        }
    }
    ...
    void setScale(float scale=1) {
        ...
        this.sky.width = this.background_width;
        this.sky.height = this.background_height;
    }

    ~this() {
        UnloadTexture(this.background1);
        UnloadTexture(this.background2);
        UnloadTexture(this.background3);
        UnloadTexture(this.sky);
    }
}